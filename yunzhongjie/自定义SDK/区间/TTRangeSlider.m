...
- (void)initialiseControl {
    ...
    self.sliderLine.backgroundColor = CLBlueBtnColor.CGColor;//self.tintColor.CGColor;
    ...
    self.leftHandle.backgroundColor = CLBlueBtnColor.CGColor;//self.tintColor.CGColor;
    ...
    self.rightHandle.backgroundColor = CLBlueBtnColor.CGColor;//self.tintColor.CGColor;
    ...
    if (self.minLabelColour == nil){
        self.minLabel.foregroundColor = CLBlueBtnColor.CGColor;//self.tintColor.CGColor;
    } else {
    ...
    if (self.maxLabelColour == nil){
        self.maxLabel.foregroundColor = CLBlueBtnColor.CGColor;//self.tintColor.CGColor;
    } else {
