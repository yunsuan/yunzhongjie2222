...
-(void)initUI{
    ...
    _titelL =[[UILabel alloc]initWithFrame:CGRectMake(10*SIZE, 10*SIZE, 300*SIZE, 14*SIZE)];
//    _titelL.text = @"号码判重";
...
//    _nameL.text = @"姓名：李想";
    ...
    _statusL = [[UILabel alloc]initWithFrame:CGRectMake(310*SIZE, 10*SIZE, 40*SIZE, 14*SIZE)];
    ...
    _statusL.layer.cornerRadius = 2 *SIZE;
    _statusL.clipsToBounds = YES;
