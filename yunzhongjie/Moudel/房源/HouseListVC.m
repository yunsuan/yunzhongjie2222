...
-(void)initUI{
    _table = [[UITableView alloc] initWithFrame:CGRectMake(0,40*SIZE, SCREEN_Width, SCREEN_Height - NAVIGATION_BAR_HEIGHT - TAB_BAR_HEIGHT-80*SIZE) style:UITableViewStylePlain];
