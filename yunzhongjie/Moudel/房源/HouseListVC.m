...
-(void)initUI{
    _table = [[UITableView alloc] initWithFrame:CGRectMake(0,0, SCREEN_Width, SCREEN_Height - NAVIGATION_BAR_HEIGHT - TAB_BAR_HEIGHT-40*SIZE) style:UITableViewStylePlain];
