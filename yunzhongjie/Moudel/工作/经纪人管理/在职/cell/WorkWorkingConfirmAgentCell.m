...
- (void)setDataDic:(NSDictionary *)dataDic{
    ...
    _nameL.text = [NSString stringWithFormat:@"姓名：%@",dataDic[@""]];
    _phoneL.text = [NSString stringWithFormat:@"联系电话：%@",dataDic[@""]];
    _roleL.text = [NSString stringWithFormat:@"角色：%@",dataDic[@""]];
    _timeL.text = [NSString stringWithFormat:@"申请时间：%@",dataDic[@""]];
    _projectL.text = [NSString stringWithFormat:@"申请项目：%@",dataDic[@""]];
    _storeL.text = [NSString stringWithFormat:@"申请项目：%@",dataDic[@""]];
}
