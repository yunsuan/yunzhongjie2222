...
@interface MaintainCustomVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation MaintainCustomVC
...
- (void)initDataSource{
    ...
    for (int i = 0; i < [_dataDic[@"tel"] count]; i++) {
        ...
        [_contentArr insertObject:[NSString stringWithFormat:@"联系号码%d：%@",i + 1,_dataDic[@"tel"][i]] atIndex:(2 + i)];
    }
}
...
//        [_table reloadData];
//        if (self.maintainCustomVCBlock) {
//
//            self.maintainCustomVCBlock();
//        }
//    };
