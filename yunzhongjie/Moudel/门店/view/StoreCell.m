...
-(void)initUI{
    ...
    _headerImg.frame = CGRectMake(10*SIZE, 10*SIZE, 110*SIZE, 82*SIZE);
    ...
    _adressL = [[UILabel alloc]initWithFrame:CGRectMake(130*SIZE, 33*SIZE, 200*SIZE, 14*SIZE)];
    ...
    //    [self addSubview:_headerImg];
    _nameL = [[UILabel alloc]initWithFrame:CGRectMake(130*SIZE, 56*SIZE, 200*SIZE, 14*SIZE)];
        _nameL.text = @"店长：张三，李四";
    _nameL.textColor = CLContentLabColor;
    _nameL.font = FONT(12);
    [self addSubview:_nameL];
    
    _phoneL = [[UILabel alloc]initWithFrame:CGRectMake(130*SIZE, 80*SIZE, 200*SIZE, 13*SIZE)];
